...
<body class="bg-bg-primary min-h-screen flex" x-data="{ sidebarOpen: true }">
    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            ...
            <x-nav-item href="#" :active="false" icon="trending-down">
                Contas a Pagar
            </x-nav-item>
            ...
            <x-nav-item href="#" :active="false" icon="file-text">
                Contratos
            </x-nav-item>

            <x-nav-item href="#" :active="false" icon="layers">
                Serviços
            </x-nav-item>

            <x-nav-item href="#" :active="false" icon="package">
                Produtos
            </x-nav-item>
        </nav>
