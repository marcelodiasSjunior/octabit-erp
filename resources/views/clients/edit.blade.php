...
<x-layouts.app :title="'Editar ' . $entityLabel . ' — ' . $client->name" :header="$sectionLabel . ' / ' . $client->name">
    ...
    <div id="edit-client-container" class="max-w-2xl">
        <div id="edit-client-card" class="card">
            <h2 class="text-base font-semibold text-slate-200 mb-6">Editar {{ $entityLabel }}</h2>

            <form id="form-edit-client" method="POST" action="{{ route('clients.update', $client) }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" id="input-client-name" name="name" value="{{ old('name', $client->name) }}"
                    ...
                    <div class="sm:col-span-2">
                        <label for="input-client-company" class="label">Empresa</label>
                        <input type="text" id="input-client-company" name="company_name"
                               value="{{ old('company_name', $client->company_name) }}"
                               class="input"/>
                    </div>

                    <div>
                        <label for="input-client-document" class="label">CPF / CNPJ <span class="text-red-500">*</span></label>
                        <input type="text" id="input-client-document" name="document"
                    ...
                    <div>
                        <label for="input-client-phone" class="label">Telefone</label>
                        <input type="tel" id="input-client-phone" name="phone"
                    ...
                    <div>
                        ...
                        <input type="email" id="input-client-email" name="email"
                    ...
                    <div class="sm:col-span-2">
                        <label for="textarea-client-notes" class="label">Observações</label>
                ...
                <div id="form-actions" class="flex items-center gap-3 mt-6 pt-5 border-t border-bg-border">
                    ...
                    <a id="btn-cancel-client" href="{{ $isLeads ? route('leads.index') : route('clients.show', $client) }}" class="btn-secondary">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
