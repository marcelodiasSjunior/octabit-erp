<x-layouts.app title="Novo Contrato" header="Contratos / Novo">
    ...
    <div id="create-contract-card" class="max-w-2xl">
        <div class="card">
            <h2 class="text-base font-semibold text-slate-200 mb-6">Dados do Contrato</h2>

            <form id="form-create-contract" method="POST" action="{{ route('contracts.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="input-contract-value" name="value" value="{{ old('value') }}"
                    ...
                    <div>
                        ...
                        <input type="date" id="input-contract-end-date" name="end_date" value="{{ old('end_date') }}"
                               class="input"/>
                    </div>
                ...
                <div class="flex items-center gap-3 mt-6 pt-4 border-t border-bg-border">
                    <button id="btn-save-contract" type="submit" class="btn-primary">Criar Contrato</button>
                    <a id="btn-cancel-contract" href="{{ route('contracts.index') }}" class="btn-ghost">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
