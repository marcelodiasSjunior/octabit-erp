...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Novo Orçamento','header' => 'Orçamentos / Novo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Novo Orçamento','header' => 'Orçamentos / Novo']); ?>
    ...
    <div class="max-w-4xl"
        ...
        <form method="POST" action="<?php echo e(route('quotes.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('quotes.index')); ?>" class="btn-ghost">Cancelar</a>
            </div>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/quotes/create.blade.php ENDPATH**/ ?>